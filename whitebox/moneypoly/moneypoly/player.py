...
class Player:
    ...
    def net_worth(self):
        ...
        property_value = sum(prop.mortgage_value() for prop in self.properties)
    ...
    def go_to_jail(self):
        ...
        self.jail_status["in_jail"] = True
        self.jail_status["jail_turns"] = 0
    ...
    def status_line(self):
        ...
        jail_tag = " [JAILED]" if self.jail_status["in_jail"] else ""
        return (
